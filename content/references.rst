...
.. [Squires1978]
    G. L. Squires,
    *Introduction to the Theory of Thermal Neutron Scattering* (Cambridge University Press, 1978).
...
.. [Meo2023]
    ...
    *Spin-transfer and spin-orbit torques in the Landau–Lifshitz–Gilbert equation*,
    J. Phys.: Condens. Matter **35**, 025801 (2023).
...
.. [Evans2000]
    ...
    *Statistical mechanics of nonequilibrium liquids.*
    Academic Press, London, 2nd edition (2008).

.. [Holian1995]
    B. L. Holian, A. F. Voter, and R. Ravelo,
    *Molecular dynamics of shock waves in one-dimensional systems.*
    Phys. Rev. E **52**, 2338–2356 (1995).
...
.. [Binney1992]
    ...
    *The Theory of Critical Phenomena: An Introduction to the Renormalization Group.*
    Oxford University Press, Oxford, 1st edition (1992).
...
.. [Hinzke2000]
    ...
    *Stochastic dynamics of magnetic nanoparticles.*
...
.. [Ruban2004]
    A. V. Ruban, S. Skriver, and J. K. Nørskov,
    *Surface segregation energies in transition-metal alloys.*
    Phys. Rev. B **59**, 15990–16000 (1999).

.. [Ebert2010]
    H. Ebert, D. Kodderitzsch, and J. Minár,
    *Calculating Condensed Matter Properties Using the KKR-Green's Function Method.*
...
.. [Pankratova2022]
    ...
    Physical Review B **106**, 174407 (2022).
...
.. [Geyer1995]
    ...
    in *Computing Science and Statistics: Proceedings of the 23rd Symposium on the Interface* (Interface Foundation, 1991), pp. 156–163.
...
.. [Bessarab2012]
    ...
    "Method for finding mechanism and activation energy of magnetic transitions applied to skyrmion and antivortex annihilation," *Comput. Phys. Commun.* **196**, 335 (2015).


.. [Bessarab2015]
    P. F. Bessarab, V. M. Uzdin, and H. Jónsson,
    "Harmonic transition-state theory of thermal spin-flip transitions," *Phys. Rev. B* **85**, 184409 (2012).


.. [Henkelman2000]
    G. Henkelman, B. P. Uberuaga, and H. Jónsson,
    "A climbing image nudged elastic band method for finding saddle points and minimum energy paths," *J. Chem. Phys.* **113**, 9901 (2000).
