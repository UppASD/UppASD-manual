...
Magnon dispersions require a list of **q-points** (momentum space sampling). See :doc:`input-keywords-correlations` for details on q-point generation and dynamic structure factor output.
...
* :doc:`input-keywords-correlations` (Q-point generation and dynamic structure factor)
* :doc:`input-keywords-correlations` (Dynamical spin correlation :math:`S(\mathbf{q}, \omega)`)
* :doc:`input-keywords-stiffness` (Spin-wave stiffness and micromagnetic parameters)
* :doc:`input-keywords-simulation` (Temperature control and equilibration)
