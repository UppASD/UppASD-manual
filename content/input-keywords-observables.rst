...
This page is a comprehensive reference for all observable and measurement-related input keywords in UppASD. Keywords are organized by category. For detailed physics background and formulas, see the dedicated chapters: :doc:`input-keywords-averages`, :doc:`input-keywords-correlations`, :doc:`input-keywords-autocorrelation`, and :doc:`input-keywords-polarization`.
...
``do_avrg``
   ...
   (Y=yes, *N=no*). Output: ``averages.simid.out``. See :doc:`input-keywords-averages` for details.
   Default: **N**.
...
``do_sc``
   ...
   and/or static :math:`S(\mathbf{q})`. See :doc:`input-keywords-correlations`.
   Default: **N**.
...
``do_autocorr``
   ...
   See :doc:`input-keywords-autocorrelation`. Default: **N**.
...
``do_pol``
   ...
   See :doc:`input-keywords-polarization`. Default: **N**.
