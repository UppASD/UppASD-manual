...
.. seealso::
   ...
   - :doc:`input-keywords-temperature-gradients` for coupling KMC with spatially varying temperatures
   - :doc:`input-keywords-sld` for full spin-lattice dynamics (alternative to KMC for faster motion)
   - :doc:`input-keywords-simulation` for temperature control and ensemble settings in equilibrium simulations
