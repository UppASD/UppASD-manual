...
- ``real_time_measure``: Output physical time instead of steps (see :doc:`input-keywords-simulation`)
- ``do_macro_cells``: Enable spatial macrocell subdivision (see :doc:`input-keywords-system`)
- ``macro_cell_size``: Size of macrocells in physical units (see :doc:`input-keywords-system`)
