...
- :doc:`../input/system` (host system definition)
- :doc:`../input/core-files` (core file formats: ``posfile``, ``momfile``, etc.)
- :doc:`../input/hamiltonian` (exchange coupling definitions)
- :doc:`../input/observables` (site-resolved outputs and per-site writing)